...
public class ApplicationStartup {
    public static void main(String[] args) throws Exception {
        ...
        double fx = minimizer.getFX(file.getGoal(), file.getDynamites().size(), resultSet.size());
        int weight = resultSet.stream().mapToInt(Dynamite::getPower).sum();
        Logger.createCSVResults(algo, weight, file.getGoal() - weight, timeElapsed, fx);
    }
